...
let package = Package(
  name: "SomeProject",
  dependencies: [
    .package(url: "https://github.com/HyperfocusDisordered/FoundationExtensions.git", from: "1.2.0")
  ],
  targets: [
    .target(name: "SomeProject", dependencies: ["FoundationExtensions"])
  ]
)
```
```ruby
